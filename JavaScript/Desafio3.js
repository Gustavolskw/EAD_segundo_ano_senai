...
console.log(pessoa.andando, pessoa.caminhouQuantosMetros);
...
pessoa.apresentacao = () => {
    ...
    return `Olá, eu sou ${pessoa.sexo == 1 ? "o " + pessoa.nome + " " + pessoa.sobrenome : "a " + pessoa.nome + " " + pessoa.sobrenome}, tenho ${pessoa.idade == 1 ? pessoa.idade + " ano" : pessoa.idade + " anos"}, ${pessoa.altura} de altura, meu
peso é ${pessoa.peso}kg e, só hoje, eu já caminhei ${pessoa.caminhouQuantosMetros}
metros!`
